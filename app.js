/*
Secure Message Encryptor - rewritten hardened app.js

Key fixes in this version:
- New private backups include the matching public identity inside the encrypted backup.
- Fresh browser sessions can restore identity by importing the private backup.
- Encrypted private backup text is not retained in memoryState after create/import.
- Private keys are imported as non-extractable CryptoKey objects.
- Private keys auto-lock after 10 minutes.
- Private keys lock when the tab is hidden or the page is closed.
- Importing someone else's public address only adds them as a contact.
- Legacy v1/v2 localStorage private-bundle keys are deleted on load.
*/
